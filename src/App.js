  ...
  render(){
    return(
      <div>
        ...
        <button onClick={this.Update}>Push me!)</button>
  ...
  componentDidMount() {
    const newIntervalId = setInterval(() => {
      this.setState(prevState => {
        ...
        return {
          ...prevState,
          count: 1, //if we want to count how many times it updated prevState.count + 1
        };
      });
    }, 1000);
...
class Parent extends React.Component{
  ...
  handleCounterTick(){   
    ...
    console.log("something " + this.state.state)
  }
...
function App() {
  return (
    <div className="App-header">
      {/*TASK1*/}
      <GoodbyeWorld/> 
      <Hello name = "Arina" secondName = "Piaterikova"/>
      <Bye hone = "honey"/>
